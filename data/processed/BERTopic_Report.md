...
| Incident | Comments | Mental Illness Coding | Notes |
|---|---|---|---|
| 2024年6月9日成都女子遇害案 | 156 | | |
| 景德镇一家三口被撞 | 156 | | |
| 上海瑞金医院持刀砍人案 | 139 | | |
| 湖北恩施涉校刑事案件 | 133 | | |
| 广西梧州旺甫小学保安持刀伤人 | 125 | | |
...
*Mental illness coding values: `confirmed` / `alleged` / `none` / `unclear`*  
*Fill in this table, then run `scripts/build_enriched.py` to merge the variable into the main dataset for cross-incident comparison.*
...
| File | Description |
|---|---|
| `topic_summary.csv` | All 25 topics with size and top keywords |
| `comments_with_topics.csv` | All comments tagged with topic ID and label |
| `topic_examples.txt` | Raw top-5 comments per topic |
| `figures/topic_sizes.png` | Bar chart: topic sizes by comment count |
| `figures/topic_heatmap.png` | Heatmap: topic distribution across top 15 incidents |
| `figures/topic_likes.png` | Bar chart: average likes per topic |
| `BERTopic_Report.md` | This report |
